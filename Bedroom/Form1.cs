    ...
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                {
                    case "cable":
                        last_object = draw.Drawcable(click, new Point(e.X, e.Y));
                        break;
                    case "Computer":
                        ...
                        break;
                    case "Windows":
                        Windows window = new Windows(click, new Point(e.X, e.Y));
                    ...
                    case "Arrow":
                        ...
                        break;
                    case "router":
                        router router = new router(click, new Point(e.X, e.Y));
                        last_object = draw.DrawPicture(router);
                        break;
                    case "server":
                        server armchair = new server(click, new Point(e.X, e.Y));
